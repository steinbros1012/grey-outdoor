    ...
    <>
      ...
      <section className="py-14 px-4" style={{ backgroundColor: "#F1F5F9" }}>
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl font-black text-[#1F2937] mb-6" style={{ letterSpacing: "-0.02em" }}>Industries That Succeed in Jacksonville</h2>
      ...
      <section className="py-20 px-4" style={{ backgroundColor: "#F8FAFC" }}>
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-black text-[#1F2937] mb-10" style={{ letterSpacing: "-0.02em" }}>Jacksonville Billboard Advertising FAQ</h2>
