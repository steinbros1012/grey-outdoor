        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            ...
            >
              <div className="relative flex-1">
                ...
                <select
                  ...
                  className="w-full pl-10 pr-4 py-3.5 rounded-xl border border-slate-200 bg-white text-sm font-medium text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#2464B4] focus:border-transparent appearance-none"
                >
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-[#2464B4] text-white text-sm font-bold hover:bg-[#1a4f94] transition-colors whitespace-nowrap"
              >
            ...
            <motion.p variants={fadeUp} className="mt-4 text-sm text-slate-400">
              Or{" "}
              <Link href="/inventory" className="text-[#2464B4] font-semibold hover:underline">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <motion.div variants={fadeUp} className="max-w-xl mb-16">
              <span className="inline-block text-xs font-bold text-[#2464B4] uppercase tracking-[0.2em] mb-5">
              ...
              <h2 className="text-4xl sm:text-5xl font-black text-slate-900 leading-[1.05]" style={{ letterSpacing: "-0.03em" }}>
                ...
                Can&apos;t be blocked.
                <br />
                <span className="text-[#2464B4]">Can&apos;t be ignored.</span>
              </h2>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              >
                <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-50 border border-blue-100 text-xs font-bold text-[#2464B4] uppercase tracking-widest mb-6">
                  Static
                </span>
                ...
                <ul className="space-y-3 mb-8">
                  {[
                    ...
                    <li key={item} className="flex items-center gap-3 text-sm text-slate-600">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#2464B4] flex-shrink-0" />
                      {item}
                    </li>
                  ))}
                </ul>
                <Link
                  href="/inventory"
                  className="inline-flex items-center gap-1.5 text-sm font-bold text-[#2464B4] hover:gap-3 transition-all"
                >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-14">
              ...
              <Link
                href="/locations"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border-2 border-[#2464B4] text-[#2464B4] text-sm font-bold hover:bg-[#2464B4] hover:text-white transition-all shrink-0"
              >
              ...
              {locations.map((loc) => (
                <motion.div key={loc.city} variants={fadeUp}>
                  ...
                  >
                    ...
                    <span className="inline-flex items-center gap-1 text-xs font-bold text-[#2464B4] group-hover:gap-2 transition-all">
      ...
      <section className="py-20 px-4 bg-slate-50 border-y border-slate-100">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <motion.span
              variants={fadeUp}
              className="inline-block text-xs font-bold text-[#2464B4] uppercase tracking-[0.2em] mb-5"
            >
              Industries Served
            </motion.span>
            <motion.h2
            ...
            <motion.div variants={fadeUp} className="flex flex-wrap justify-center gap-2.5">
              {industries.map((ind) => (
                <span
                  key={ind}
                  className="px-4 py-2 rounded-full text-sm font-semibold text-slate-700 bg-white border border-slate-200 shadow-sm hover:border-blue-200 hover:text-[#2464B4] transition-colors cursor-default"
                >
                  {ind}
                </span>
              ))}
