...
export default function LeadForm({
  ...
  const inputClass = dark
    ...
    : "w-full px-4 py-3 rounded-lg text-[#1F2937] placeholder-[#94A3B8] focus:outline-none focus:ring-2 focus:ring-[#4B5563] transition-shadow text-sm border border-[#E2E8F0]";
  ...
  if (submitted) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-2xl font-bold mb-2" style={{ color: dark ? "#F8FAFC" : "#1F2937" }}>Request Received!</h3>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <select
            ...
            style={{
              ...inputStyle,
              color: dark ? (form.market ? "#F8FAFC" : "rgba(248,250,252,0.3)") : "#1F2937",
            }}
          ...
          >
            ...
            {markets.map((m) => (
              <option key={m} value={m} style={{ color: "#1F2937", backgroundColor: "#fff" }}>
                {m}
              </option>
            ))}
          </select>
        ...
        <button
          ...
          style={{ backgroundColor: dark ? "#4B5563" : "#0047CC" }}
        >
